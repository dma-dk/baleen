...
public class SecomClient {
    ...
    public SecomClient(HttpClient client, String baseUri, SecomConfiguration configuration) {
    ...
    public Optional<UploadResponseObject> upload(UploadObject uploadObject, MRNClient mrn) {
